...
public class AlumnosTest {
    ...
    private static final String ERROR_NO_MAS_ALUMNOS = "ERROR: No se aceptan mas alumnos.";
    private static final String ERROR_ALUMNO_EXISTE = "ERROR: Ya existe un alumno con ese dni.";
    private static final String ERROR_ALUMNO_BORRAR_NO_EXISTE = "ERROR: No existe ningun alumno como el indicado.";
    ...
    private static final String ALUMNO_NULO = "Deberia haber saltado una excepcion indicando que no se puede operar con un alumno nulo.";
    ...
    private static final String ALUMNOS_NO_CREADOS = "Deberia haber creado los alumnos correctamente.";
    ...
    public void insertarAlumnoValidoInsertaAlumnoCorrectamente() {
        ...
        try {
            ...
            List<Alumno> copiaAlumnos = alumnos.get();
            assertEquals(1, alumnos.getTamano(), TAMANO_NO_ESPERADO);
            assertEquals(alumno1, alumnos.buscar(alumno1), ALUMNO_NO_ESPERADO);
            assertNotSame(alumno1, copiaAlumnos.get(0), REFERENCIA_NO_ESPERADA);
            assertEquals(alumno1, copiaAlumnos.get(0), OPERACION_NO_REALIZADA);
    ...
    public void insertarDosAlumnosValidosInsertaAlumnosCorrectamente() {
        ...
        try {
            ...
            assertNotSame(alumno2, copiaAlumnos.get(1), REFERENCIA_NO_ESPERADA);
            assertEquals(alumno2, copiaAlumnos.get(1), OPERACION_NO_REALIZADA);
        } catch (OperationNotSupportedException e) {
            fail(EXCEPCION_NO_PROCEDE);
        }
    }
    ...
    public void insertarTresAlumnosValidosInsertaAlumnosCorrectamente() {
        ...
        try {
            ...
            assertNotSame(alumno3, copiaAlumnos.get(2), REFERENCIA_NO_ESPERADA);
            assertEquals(alumno3, copiaAlumnos.get(2), OPERACION_NO_REALIZADA);
