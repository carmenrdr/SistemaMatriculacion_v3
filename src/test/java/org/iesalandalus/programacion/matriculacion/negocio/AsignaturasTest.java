...
public class AsignaturasTest {
    ...
    private static final String ERROR_NO_MAS_ASIGNATURAS = "ERROR: No se aceptan mas asignaturas.";
    private static final String ERROR_ASIGNATURA_EXISTE = "ERROR: Ya existe una asignatura con ese codigo.";
    ...
    private static final String ASIGNATURAS_NO_CREADAS = "Deberia haber creado las asignaturas correctamente.";
    ...
    public void insertarAsignaturaValidaInsertaAsignaturaCorrectamente() {
        ...
        try {
            ...
            List<Asignatura> copiaAsignaturas = asignaturas.get();
            ...
            assertNotSame(asignatura1, copiaAsignaturas.get(0), REFERENCIA_NO_ESPERADA);
            assertEquals(asignatura1, copiaAsignaturas.get(0), OPERACION_NO_REALIZADA);
    ...
    public void insertarDosAsignaturasValidasInsertaAsignaturasCorrectamente() {
        ...
        try {
            ...
            assertNotSame(asignatura2, copiaAsignaturas.get(1), REFERENCIA_NO_ESPERADA);
            assertEquals(asignatura2, copiaAsignaturas.get(1), OPERACION_NO_REALIZADA);
        } catch (OperationNotSupportedException e) {
            fail(EXCEPCION_NO_PROCEDE);
        }
    }
    ...
    public void insertarTresAsignaturasValidasInsertaAsignaturasCorrectamente() {
        ...
        try {
            ...
            assertNotSame(asignatura3, copiaAsignaturas.get(2), REFERENCIA_NO_ESPERADA);
            assertEquals(asignatura3, copiaAsignaturas.get(2), OPERACION_NO_REALIZADA);
